    ...
    <div className="space-y-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
                ...
                <p className="text-muted-foreground">Overview of male students' status and needs.</p>
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Total male boarding students in active term</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
            ...
            <CardDescription>A list of male students who have missing required items. <Link href="/dashboard/patron/utilities" className="text-primary underline">View all</Link>.</CardDescription>
            </CardHeader>
            <CardContent>
            <Table>
                <TableHeader>
