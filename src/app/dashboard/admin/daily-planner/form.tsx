// This is a placeholder file. The content from the original daily-planner form can be moved here.
'use client';
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder={`e.g., "Oversee all school operations, manage staff, handle budgeting, and ensure curriculum standards are met."`}
                        {...field}
                        rows={4}
                      />
                    </FormControl>
