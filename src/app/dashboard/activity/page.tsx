    ...
    if (error) {
        return (
            <Card className="bg-destructive/10 border-destructive">
                ...
                <CardContent>
                    <p>Could not load activity feed: {error.message}</p>
                </CardContent>
            </Card>
        )
    }
                ...
                <CardHeader>
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        <div>
                            ...
                            <CardDescription className="text-base mt-1">A log of all your notifications and system events.</CardDescription>
                        </div>
