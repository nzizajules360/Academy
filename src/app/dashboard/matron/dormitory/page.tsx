        ...
        >
            <div className="space-y-2">
                <h1 className="text-4xl font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                    Female Dormitory Overview
                </h1>
                <p className="text-lg text-muted-foreground max-w-2xl">
                    View bed assignments for all female students in the active term.
                </p>
            </div>
            ...
            {sortedBeds.length === 0 ? (
                 <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl overflow-hidden">
                    <CardContent className="p-16 text-center text-muted-foreground">
                        ...
                        <p>No female students have been assigned to a dormitory bed for the active term.</p>
                    </CardContent>
                 </Card>
            ) : (
                            ...
                            <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                                <CardHeader className="bg-gradient-to-r from-pink-500/5 to-rose-500/5 border-b">
                                    <CardTitle className="flex items-center gap-3">
                                        <BedDouble className="h-6 w-6 text-pink-500"/>
                                        Bed #{bedNumber}
                                    </CardTitle>
                                    <CardDescription>
