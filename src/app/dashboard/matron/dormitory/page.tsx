...
import { Loader2, BedDouble, Users, Sparkles, AlertCircle, CheckCircle2, User } from 'lucide-react';
        ...
        <div className="min-h-screen pb-12">
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    >
                        <BedDouble className="h-8 w-8 text-pink-500" />
                    </motion.div>
                    <div>
                ...
                <p className="text-lg text-muted-foreground max-w-3xl">
                    Real-time overview of bed assignments and dormitory occupancy for female students.
                </p>
            </motion.div>
                            ...
                            <CardContent className="p-6">
                                <div className="relative">
                                    ...
                                    {searchQuery && (
                                        <Badge 
                                            variant="secondary" 
                                            className="absolute right-3 top-1/2 -translate-y-1/2 bg-pink-500/10 text-pink-600 border-pink-500/20"
                                        >
                    ...
                    >
                        <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl overflow-hidden">
                            ...
                            <CardContent className="relative z-10 p-16 text-center">
                                ...
                                >
                                    <BedDouble className="mx-auto h-16 w-16 mb-4 text-pink-500/50"/>
                                </motion.div>
                                <h3 className="text-2xl font-bold mb-2">No Beds Assigned</h3>
                                <p className="text-muted-foreground max-w-md mx-auto">
                                    No female students have been assigned to dormitory beds for the active term yet.
                                </p>
                            </CardContent>
                        </Card>
                    </motion.div>
                                        ...
                                        <CardHeader className="relative z-10 bg-gradient-to-r from-pink-500/10 to-purple-500/10 border-b border-border/50">
                                            <div className="flex items-center justify-between">
                                                <CardTitle className="flex items-center gap-3">
                                                    <motion.div 
                                                        className="p-2 rounded-lg bg-gradient-to-br from-pink-500/20 to-purple-500/20 border border-pink-500/20"
                                                        whileHover={{ scale: 1.1, rotate: 5 }}
                                                        transition={{ type: "spring", stiffness: 400, damping: 10 }}
                                                    >
                                        ...
                                        <CardContent className="relative z-10 p-6 space-y-4">
                                            {assignedStudents.map((s, idx) => (
                                                <motion.div 
                                                    ...
                                                    className="flex items-center gap-4 p-3 rounded-lg bg-background/50 backdrop-blur-sm border border-border/50 hover:border-pink-500/30 transition-colors"
                                                >
                                                    <Avatar className="h-12 w-12 border-2 border-pink-500/20">
                                                        <AvatarFallback className="bg-gradient-to-br from-pink-500/20 to-purple-500/20 text-pink-600 font-semibold">
                                                            {s.name.charAt(0)}
                                                        </AvatarFallback>
                                                    </Avatar>
