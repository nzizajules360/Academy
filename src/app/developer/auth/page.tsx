                ...
                <CardContent>
                  <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="login-secret" className="text-sm font-medium">Developer Secret Code</Label>
                      <Input
                        id="login-secret"
                        type="password"
                        value={secretCode}
              ...
              <TabsContent value="register">
                ...
                <CardContent>
                  <form onSubmit={handleRegister} className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="register-secret" className="text-sm font-medium">Developer Secret Code</Label>
                      <Input
                        id="register-secret"
                        type="password"
                        value={secretCode}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="admin-code" className="text-sm font-medium">Admin Authorization Code</Label>
                      <Input
                        id="admin-code"
                        type="password"
                        value={adminCode}
